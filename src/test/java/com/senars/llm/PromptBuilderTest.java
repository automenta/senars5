...
class PromptBuilderTest {
    ...
    void testBuildWithPlaceholderImplementation() {
        ...
        Thought focusThought = new Thought(
                ...
                new ThoughtContent("This is a test thought.", null, null, null, null),
    ...
    void testBuildWithSchemaAndContext() {
        ...
        Thought schema = new Thought(
                UUID.randomUUID().toString(),
                new ThoughtContent("Analyze the following. Main subject: {{focus}}. Supporting data: {{context}}.", null, null, null, null),
                new ThoughtState(1.0, 1.0, 1.0),
        ...
        Thought focusThought = new Thought(
                UUID.randomUUID().toString(),
                new ThoughtContent("The topic is AI.", null, null, null, null),
                new ThoughtState(1.0, 1.0, 1.0),
        ...
        List<Thought> context = List.of(
                new Thought(
                        UUID.randomUUID().toString(),
                        new ThoughtContent("AI is advancing quickly.", null, null, null, null),
                        new ThoughtState(1.0, 1.0, 1.0),
                        new ThoughtMetadata(ThoughtType.BELIEF, ThoughtOrigin.PERCEPTION, Collections.emptyList(), Instant.now())
                ),
                new Thought(
                        UUID.randomUUID().toString(),
                        new ThoughtContent("There are many new models.", null, null, null, null),
                        new ThoughtState(1.0, 1.0, 1.0),
                        new ThoughtMetadata(ThoughtType.BELIEF, ThoughtOrigin.PERCEPTION, Collections.emptyList(), Instant.now())
                )
        );
